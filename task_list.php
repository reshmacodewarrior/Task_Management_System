			...
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
					...
					if($_SESSION['login_type'] == 2){
						...
						$where = "where t.Assign_to ='{$_SESSION['login_firstname']}'OR p.user_ids ='{$_SESSION['login_id']}' ";
					}
					...
					<tr>
						...
						<td>
					     <p><b><?php echo ucwords($row['Dep_Task_id']) ?></b></p>
						</td>
						...
						<td class="Assign to">
						<p><b><?php echo ucwords($row['Assign_to']) ?></b></p>
					    </td>
						<td class="Estimate time">
						<p><b><?php echo ucwords($row['Estimate_time']) ?></b></p>
					    </td>
						<td class="DepUserId">
						<p><b><?php echo ucwords($row['Dep_User_id']) ?></b></p>
						</td>
					</tr>
				<?php endwhile; ?>
				</tbody>
